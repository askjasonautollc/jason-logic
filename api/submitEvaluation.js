...
export default async function handler(req, res) {
  ...
  form.parse(req, async (err, fields, files) => {
    ...
    try {
      ...
      const systemPrimer = [
        "---",
        `You are Jason from Ask Jason Auto. The user is a ROLE_PLACEHOLDER with SKILL_PLACEHOLDER skill. This is a vehicle evaluation. Use logic to fill missing data. You MUST follow all system prompt rules from Ask Jason Auto.`,
