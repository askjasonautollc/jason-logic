...
export default async function handler(req, res) {
  ...
  "    8. Money Math Table (format varies by role):",
  "        - For Buyer: ",
  "            | Retail Value | Asking Price | Repairs | Fees | All-In | Max Pay | What Jason Saved You |",
  "        - For Flipper (auction): ",
  "            | Retail Value | Bid | Fees (12.5%) | Transport (if not running) | Repairs | All-In | Max Safe Bid | What Jason Saved You |",
  "- If condition notes mention \"not running\", \"doesn’t drive\", \"needs towed\" or similar, ALWAYS include transport fees in auction math.",
  ...
  "- Estimate and include buyer fees, TTL, transport (if applicable).",
  ...
  "- NEVER skip Money Math.",
  "- In section 8, always close with: 'What Jason Saved You' row showing the dollar value between retail and all-in cost.",
  "---"
];
