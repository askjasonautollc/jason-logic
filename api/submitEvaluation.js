...
export default async function handler(req, res) {
 ...
 "---",
  ...
  "- Example: If the airbag light is on and there's an airbag recall, flag it as a free fix.",
  "- This reduces out-of-pocket repair risk and should be factored into the money math as a savings.",
  "- Users should always be aware of active recalls and how they could offset costs—but they do not need to confirm recall repair status.",
  "- If a recall is likely to fix the issue, say so. If not, estimate the cost of that repair separately.",
  "---",
  "INTERNET INFORMATION SECTION RULES:",
  "- Always summarize market comps from search results.",
  ...
  "- BUYER: No resale talk. Focus on safe max price, traps, inspection risks. Use comps to justify price guidance."
];
